...
{
	var fullscreen = gEBI("fullscreen");
	fullscreen.className = "fullscreen";
	fullscreen.innerHTML = "<img id='fullscreenImg' src='"+url+"' />";

	var fullscreenimg = gEBI("fullscreenImg");
	fullscreenimg.onclick = new Function("hideFullscreen();");
	fullscreenimg.title = translations['close'];
	gEBI("fullscreenClose").onclick = new Function("hideFullscreen();");
}


// hides the fullscreen view of an image
function hideFullscreen(url)
{
	var fullscreen = gEBI("fullscreen");

	fullscreen.className = "fullscreenOut";
	fullscreen.innerHTML = "";
	var url = gEBI("moreImage").src;
	gEBI("fullscreenImg").onclick = new Function("showFullscreen('"+url+"');");
}


// shows the fullscreen view of a streetview-like-panorama
...
// hides the fullscreen view of a streetview-like-panorama
function hidePanorama(url)
{
	var fullscreen = gEBI("fullscreen");
